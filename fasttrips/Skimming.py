...
class SkimConfig(object):
    ...
    def validate_options(self):
        ...
        if self.sampling_interval > (self.end_time - self.start_time):
...
class Skimming(object):
    ...
    def _trip_list_for_skimming(pathset_paths_df, d_t, skim_config):
        ...
        trip_list[Passenger.TRIP_LIST_COLUMN_VOT] = skim_config.vot
...
class SkimmingQueueInputData(QueueData):
    def __init__(self, state, origin, d_t, skim_config: SkimConfig, trace):
