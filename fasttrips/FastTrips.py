...
class FastTrips(object):
    ...
    def read_input_files(self):
        ...
        self.passengers = Passenger(Assignment.INPUT_DEMAND_DIR, Assignment.OUTPUT_DIR, Assignment.NETWORK_BUILD_DATE,
                                    self.stops, self.routes, Assignment.CAPACITY_CONSTRAINT)
