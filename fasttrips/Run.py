...
def run_setup(input_net_dir = '',
    ...
    if not output_folder:
        output_folder = "output_%s_iter%d_%s" % (pathfinding_type, iters, "cap" if capacity else "nocap")
    ...
    if kwargs.has_key("number_of_processes"):
        fasttrips.Assignment.NUMBER_OF_PROCESSES = kwarges["number_of_processes"]
