# -*- coding: utf-8 -*-
#
# fasttrips documentation build configuration file, created by
...
breathe_projects = { "fast-trips-cpp": os.path.join("doxygen","xml")}
...
release = 'Development Branch Commit 5e504cb3319b58faac3aca1310cb4ad08dc44ed8'
...
htmlhelp_basename = 'fasttripsdoc'
...
latex_documents = [
  (master_doc, 'fasttrips.tex', u'fasttrips Documentation',
   u'Lisa Zorn', 'manual'),
]
...
man_pages = [
    (master_doc, 'fasttrips', u'fasttrips Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'fasttrips', u'fasttrips Documentation',
   author, 'fasttrips', 'One line description of project.',
   'Miscellaneous'),
]
