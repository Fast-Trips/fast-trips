...
_fasttrips_initialize_parameters(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "ddddidiiiid", &time_window, &bump_buffer, &depart_early_allowed_min, &arrive_late_allowed_min,
    ...
    pathfinder.initializeParameters(time_window, bump_buffer, depart_early_allowed_min, arrive_late_allowed_min, stoch_pathset_size, stoch_dispersion, stoch_max_stop_process_count,
