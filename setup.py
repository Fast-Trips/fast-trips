...
setup(name          = 'fasttrips',
      ...
      package_dir   = { 'fasttrips':'' },
      package_data  = { 'fasttrips':['Examples/test_scenario/demand_reg/*', 'Examples/test_scenario/demand_twopaths/*','Examples/test_scenario/network/*','tests/*.py'] },
